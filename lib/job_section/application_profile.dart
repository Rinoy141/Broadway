...
//
// class _ApplicationProfileState extends State<ApplicationProfile> {
//   String? file;  // Changed to nullable File type
//   String imageurl = "";
//
...
//     if (pickedFile != null) {
//       setState(() {
//         file = File(pickedFile.path); // Create a File object using the picked file path.
//       });
//     }
//   }
//
...
//                               ? CircleAvatar(
//                             radius: w * 0.15,
//                             backgroundImage: FileImage(file! as File),
//                           )
//                               : CircleAvatar(
//                             radius: w * 0.15,
//                             backgroundColor: thecolors.secondary, // Placeholder color
//                           )
//                       ),
//                       Positioned(
//                         left: w * 0.18,
...
import 'package:image_picker/image_picker.dart';
import 'package:provider/provider.dart';
// import 'file_picker.dart'; // Conditional import for platform-specific file handling
...
class _ApplicationProfileState extends State<ApplicationProfile> {
  File? file; // Nullable File to handle platform-specific file types
  String imageurl = "";
