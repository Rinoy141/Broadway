...
//   @override
//   _RecommendedRestaurantsWidgetState createState() => _RecommendedRestaurantsWidgetState();
// }

// class _RecommendedRestaurantsWidgetState extends State<RecommendedRestaurantsWidget> {
...
//   void _fetchRecommendedRestaurantsIfNeeded() {
//     final loginProvider = Provider.of<MainProvider>(context, listen: false);
//     if (!_hasFetchedInitially && loginProvider.recommendedRestaurants.isEmpty) {
//       loginProvider.fetchRecommendedRestaurants().then((_) {
//         setState(() {
...
//         if (mainProvider.isLoadingRecommended) {
//           return const Center(child: CircularProgressIndicator());
//         }

//         if (mainProvider.recommendedRestaurants.isEmpty) {
//           return const Center(
