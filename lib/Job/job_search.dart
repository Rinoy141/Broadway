import 'package:broadway/Job/filter_page.dart';
import 'package:broadway/Job/notification.dart';
import 'package:broadway/Job/one_job_desc.dart';
                ...
                Row(
                  children: [
                    ...
                    InkWell(
                        ...
                        child: Container(child: Image.asset(theImages.BrandStrategist))),
                    InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) =>notification() ,));
                        },
                        child: Container(child: Image.asset(theImages.blackforest))),
                  ],
                ),
                SizedBox(height: 10),
                SizedBox(
...
//                       if (jobProvider.error.isNotEmpty) {
//                         return Center(child: Text(jobProvider.error));
//                       }

//                       return ListView.builder(
//                         itemCount: jobProvider.jobResults.length,
//                         itemBuilder: (context, index) {
//                           final job = jobProvider.jobResults[index];
//                           return Padding(
//                             padding: EdgeInsets.all(w * 0.03),
//                             child: InkWell(
//                               onTap: () {
...
//                                   context,
//                                   MaterialPageRoute(
//                                     builder: (context) => OneJobDesc(jobData: {}),
//                                   ),
//                                 );
//                               },
//                               child: Container(
...
//                                                 ),
//                                                 Text(
//                                                   'Help the team to craft the brand story & set ',
...
//                                                 SizedBox(height: h * 0.01),
//                                                 Text(
//                                                   'Manage relations with our partners/corporate',
//                                                   style: TextStyle(fontSize: w * 0.03),
//                                                 ),
//                                               ],
//                                             )
